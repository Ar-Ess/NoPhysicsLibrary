...
public:
	...
	inline void ApplyForce(Point newtons) { forces.push_back(newtons); }
	// Applies an specific force to this body
	inline void ApplyForce(float newtonsX, float newtonsY) { forces.push_back({ newtonsX, newtonsY }); }
	// Applies an specific force to this body
	inline void ApplyMomentum(Point momentum) { forces.push_back(momentum); }
	// Applies an specific force to this body
	inline void ApplyMomentum(float momentumX, float momentumY) { forces.push_back({ momentumX, momentumY}); }
