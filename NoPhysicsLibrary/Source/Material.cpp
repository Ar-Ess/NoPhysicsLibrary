...
void Material::BuildSolid(float youngModulus, float absorptionCoefficient, float density)
{
...
void Material::BuildLiquid(float viscosity, float bulkModulus, float absorptionCoefficient, float density)
{
...
void Material::BuildGas(float heatRatio, float pressure, float absorptionCoefficient, float density)
{
